...
if ($conn->query($clearTable) === TRUE) {
    echo "<p>Existing player records were cleared from the players table.</p>";
} else {
    echo "<p>Error clearing players table: " . $conn->error . "</p>";
}
...
if ($conn->query($sql) === TRUE) {
    echo "<p>The players table was populated successfully.</p>";
    echo "<p>50 player records were inserted into the baseball_01 database.</p>";
} else {
    echo "<p>Error populating players table: " . $conn->error . "</p>";
}
