...
if ($conn->query($sql) === TRUE) {
    echo "<p class=\"success-box\">The players table was dropped successfully from the baseball_01 database.</p>";
} else {
    echo "<p class=\"error-box\">Error dropping players table: " . $conn->error . ".</p>";
}
